  ...
  return (
    <footer className="bg-gray-800 text-white py-10 mt-12">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-gray-400">
            {t('footerDescription') || "Your trusted partner for comfortable, smarter train journeys across India. Make seat exchanges hassle-free with our AI-driven matching."}
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/settings" className="text-gray-400 hover:text-white transition-colors">Accessibility Settings</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
        &copy; {new Date().getFullYear()} RailBuddy. {t('allRightsReserved') || "All rights reserved."}
      </div>
    </footer>
  );
};
